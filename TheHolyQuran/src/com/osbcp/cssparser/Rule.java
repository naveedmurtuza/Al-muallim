 ...
 *
 * @author <a href="mailto:christoffer@christoffer.me">Christoffer
 * Pettersson</a>
 */
public final class Rule {
     ...
     */
    public Rule() {
        this(new LinkedHashSet<Selector>());
    }
     ...
     */
    public Rule(final Set<Selector> selectors) {
     ...
     */
    private String implode(final Set<Selector> values) {
