...
/**
 * The
 * <code>JFontChooser</code> class is a swing component for font selection. This
 * class has
 * <code>JFileChooser</code> like APIs. The following code pops up a font
 * chooser dialog.
 * <pre>
...
//	}
    ...
    /**
     * Constructs a
     * <code>JFontChooser</code> object using the given font size array.
     *
     ...
     *
     * @param style the size of the selected font.        <code>Font.PLAIN</code>, <code>Font.BOLD</code>,
    ...
    protected JTextField getSampleTextField() {
        if (sampleText == null) {
            ...
            sampleText = new JTextField("AaBbCcDd");
