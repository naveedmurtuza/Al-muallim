// LanguageUtils
// $Id: LanguageUtils.java,v 1.5 2003/11/16 17:43:52 axelwernicke Exp $
//
...
public class LanguageUtils {
    ...
    private static final String iso639_2[][] = {
        ...
        {"Latvian", "lav"},
        {"Letzeburgesch", "ltz"},
        {"Lezghian, lezLimburgan, limlimburgish", "lim"},
        {"Lingala", "lin"},
        {"Lithuanian", "lit"},
        {"Low German", "nds"},
        {"Low Saxon", "nds"},
     ...
     * @return iso code for the language
     */
     ...
     *
     * @param langCode iso code for the language
     * @return name for the language
     */
     ...
     */
    public static List getAllLanguageNames() {
        List result = new ArrayList(iso639_2.length);
